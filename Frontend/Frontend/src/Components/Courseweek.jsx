...
//         </Button>
//         <Badge
//           className={`${week.badge} text-white`}
//           style={{ marginRight: "16px" }}
//         >
//           Week {week.week}
//         </Badge>
...
//               }}
//             >
//               Notes & Practice for Week {week.week}
//             </h2>
//             <p style={{ marginBottom: "10px", color: "#4CAF50" }}>
//               Here are detailed notes and a practice video to help you master
//               this week's topics.
//             </p>
//             {week.week === 1 ? (
//               <WeekOneSlides />
...
//             {!week.youtubeLink && (
//               <p style={{ color: "#888" }}>
//                 No YouTube link provided for this week yet.
//               </p>
//             )}
//           </div>
//         </TabsContent>
...
export const CourseWeek = ({ week, onBack, onComplete, isCompleted }) => {
  const navigate = useNavigate();
  const [isMobile, setIsMobile] = useState(window.innerWidth < 768); // Assuming 768px as breakpoint
  ...
  const activitiesCard = (
    <Card style={{
      ...
      display: 'flex',
      flexDirection: 'column',
      flex: isMobile ? '1 1 100%' : '1 1 0%', // Take full width on mobile
    }}>
      <CardHeader>
        <CardTitle style={{ fontSize: '1.125rem' }}>Week {week.week} Activities</CardTitle>
        <CardDescription style={{ fontSize: '0.875rem', color: '#6b7280' }}>Fun exercises to practice what you learn!</CardDescription>
      ...
      <CardContent style={{ display: 'flex', flexDirection: 'column', gap: '16px' }}>
        <div style={{ display: 'flex', alignItems: 'center', padding: '12px', backgroundColor: 'white', borderRadius: '8px', boxShadow: '0 1px 2px 0 rgba(0,0,0,0.05)' }}>
          <Play style={{ height: '20px', width: '20px', color: '#3b82f6', marginRight: '12px' }} />
          <div>
            <p style={{ fontWeight: '500', fontSize: '1rem' }}>Watch Video Lesson</p>
            <p style={{ fontSize: '0.875rem', color: '#4b5563' }}>15-20 minutes of fun learning</p>
          </div>
        ...
        <div style={{ display: 'flex', alignItems: 'center', padding: '12px', backgroundColor: 'white', borderRadius: '8px', boxShadow: '0 1px 2px 0 rgba(0,0,0,0.05)' }}>
          <BookOpen style={{ height: '20px', width: '20px', color: '#22c55e', marginRight: '12px' }} />
          <div>
            <p style={{ fontWeight: '500', fontSize: '1rem' }}>Read Notes & Examples</p>
            <p style={{ fontSize: '0.875rem', color: '#4b5563' }}>Easy-to-follow explanations</p>
          </div>
        ...
        <div style={{ display: 'flex', alignItems: 'center', padding: '12px', backgroundColor: 'white', borderRadius: '8px', boxShadow: '0 1px 2px 0 rgba(0,0,0,0.05)' }}>
          <Code style={{ height: '20px', width: '20px', color: '#a855f7', marginRight: '12px' }} />
          <div>
            <p style={{ fontWeight: '500', fontSize: '1rem' }}>Try Practice Exercises</p>
            <p style={{ fontSize: '0.875rem', color: '#4b5563' }}>Hands-on coding practice</p>
          </div>
    ...
    <div style={{ maxWidth: "72rem", margin: "0 auto", padding: "24px" }}>
      <div
        style={{
          ...
          marginBottom: "24px",
          gap: isMobile ? "16px" : "0", // Add gap on mobile
        }}
      >
        <Button
          variant="outline"
          onClick={back}
          style={{ marginRight: isMobile ? "0" : "16px", width: isMobile ? "100%" : "auto" }} // Full width on mobile
        >
          <ArrowLeft
            style={{ height: "16px", width: "16px", marginRight: "8px" }}
          />
        ...
        <Badge
          className={`${week.badge} text-white`}
          style={{ marginRight: isMobile ? "0" : "16px", alignSelf: isMobile ? "flex-start" : "center" }} // Adjust alignment
        >
          Week {week.week}
        </Badge>
        <div style={{ flex: "1 1 0%" }}>
          <h1
            style={{
              fontSize: isMobile ? "1.5rem" : "1.875rem", // Smaller title on mobile
              fontWeight: "bold",
              color: "#1f2937",
              marginBottom: "4px",
            }}
        ...
        {!isCompleted && (
          <Button
            onClick={onComplete}
            style={{ backgroundColor: "#22c55e", color: "white", width: isMobile ? "100%" : "auto" }} // Full width on mobile
          >
            <CheckCircle
              style={{ height: "16px", width: "16px", marginRight: "8px" }}
            />
        ...
        {isCompleted && (
          <Badge
            ...
            style={{
              ...
              justifyContent: isMobile ? "center" : "flex-start", // Center text on mobile
              padding: "10px 18px", // Consistent padding for badge
              borderRadius: "9999px",
              display: "inline-flex",
              alignItems: "center",
              fontWeight: "600",
      ...
      <Tabs defaultValue="overview" style={{ width: "100%" }}>
        <TabsList
          style={{
            display: "grid",
            width: "100%",
            gridTemplateColumns: isMobile ? "repeat(2, minmax(0, 1fr))" : "repeat(4, minmax(0, 1fr))", // 2 columns on mobile, 4 otherwise
            gap: "8px", // Added gap for better spacing on mobile
            marginBottom: "24px",
            backgroundColor: "hsl(210, 20%, 95%)", // Consistent with WeekOneDetailsPage
            borderRadius: "8px", // Consistent with WeekOneDetailsPage
            padding: "6px", // Consistent with WeekOneDetailsPage
          }}
        >
        ...
        <TabsContent value="overview">
          <div
            style={{
              display: "grid",
              gridTemplateColumns: isMobile ? "1fr" : "repeat(2, minmax(0, 1fr))", // Single column on mobile
              gap: "24px",
            }}
          >
            {/* What You'll Learn Card */}
            <Card style={{ ...getCardColorStyle(week.color), flex: isMobile ? '1 1 100%' : '1 1 0%' }}> {/* Full width on mobile */}
              <CardHeader>
                <CardTitle
                  style={{
                    display: "flex",
        ...
        <TabsContent value="notes">
          ...
          >
            <h2
              style={{
                fontSize: isMobile ? "20px" : "24px", // Smaller title on mobile
                marginBottom: "15px",
                color: "#388e3c",
              }}
            >
