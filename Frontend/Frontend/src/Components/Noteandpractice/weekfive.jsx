...
//           <br />
//           <code>var</code>, <code>function()</code>, and buttons!
//           <br />
//           <br />
//           Ready to level up?
//           <div style={{ marginTop: 16, fontStyle: "italic", color: "#888" }}>
...
//           <br />
//           <br />
//           JavaScript uses DOM to change HTML elements
//           <br />
//           Like a tree of your webpage!
//           <div style={{ marginTop: 10 }}>
//             {/* Image: DOM Tree cartoon with elements like <body>, <h1>, <p> as tree branches */}
...
//           }}
//         >
//           <b>Q1:</b> What does document.getElementById() do?
//           <br />
...
//         >
//           <div style={{ marginBottom: 16 }}>
//             Meet our magic boy who can create amazing web pages with a wave of
//             his wand.
//             <br />
//             With JavaScript and the DOM, you can make your own web magic too!
//           </div>
...
//   const [current, setCurrent] = useState(0);
//   const slide = slides[current];
//   const [isMobile, setIsMobile] = useState(window.innerWidth < 768); // Define breakpoint
...
//             </h2>
//             <div style={{ marginBottom: 16 }}>
//               {/* Adjust font size for content based on mobile */}
//               {React.cloneElement(slide.content, {
//                 style: {
//                   ...slide.content.props.style,
//                   fontSize: isMobile ? "1rem" : "1.13rem",
//                   textAlign: isMobile
//                     ? "center"
//                     : slide.content.props.style.textAlign, // Center text on mobile for general content
//                 },
//               })}
//             </div>
//             {slide.images && slide.images.length > 0 && (
...
//                     alt="slide visual"
//                     style={{
//                       maxWidth: isMobile ? "80%" : 400, // Make image max width 80% on mobile for "The Magic Web Creator!"
//                       maxHeight: isMobile ? 80 : 120, // Adjust max height for smaller images on mobile
...
import domImg from "../../assets/week3image/DOM.jpg"; // Assuming this path is correct
      ...
      >
        {selectedGroup && slides.length > 0 ? (
          <>
              ...
              >
                {slide.images.map((img, i) => (
                  <img
                    ...
                    style={{
                      maxHeight: isMobile ? 80 : 120, // Adjust max height for smaller images on mobile
                      maxWidth: "100%", // Ensure it's responsive within its flex item
            ...
            {/* Specific handling for the domImg at the end of the Magic Color Project group */}
            {selectedGroup === "Magic Color Project" &&
