...
export const Index = () => {
  ...
  const ListItemCard = ({ weekItem, handleCardClick, index }) => {
    ...
    const defaultShadow =
      "0 4px 16px rgba(108,71,255,0.07), 0 2px 4px rgba(0,0,0,0.03)";
    const hoverShadow =
      "0 8px 32px rgba(108,71,255,0.13), 0 4px 8px rgba(0,0,0,0.08)";
    ...
    return (
      ...
      >
        ...
        >
          <Badge style={badgeCommonStyle}>Week {weekItem.week}</Badge>
          <CardTitle
            style={{
              fontSize: "1.7rem",
              fontWeight: "800",
          ...
          >
            ...
            />
            <span>
              {weekItem.activitiesCount} Activit
              {weekItem.activitiesCount > 1 ? "ies" : "y"}
            </span>
          </div>
        </div>
      </Card>
