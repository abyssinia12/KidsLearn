...
//             <HoverButton
//               onClick={onComplete}
//               style={{ backgroundColor: "hsl(140, 60%, 50%)", color: "white" }}
//             >
//               <CheckCircle
//                 style={{ height: "16px", width: "16px", marginRight: "8px" }}
//               />
  ...
  return (
    ...
    >
      ...
      >
        ...
        <div style={{ flex: isMobile ? 'none' : '1' }}> {/* Adjust flex behavior */}
          <h1
            style={{
        ...
        <div style={{ alignSelf: isMobile ? "flex-start" : "flex-end", minWidth: "150px" }}> {/* Align to start on mobile */}
          {!isCompleted ? (
            <HoverButton
              onClick={onComplete}
              style={{ backgroundColor: "hsl(140, 60%, 50%)", color: "white", width: isMobile ? "100%" : "auto" }} // Full width on mobile
            >
              <CheckCircle
                style={{ height: "16px", width: "16px", marginRight: "8px" }}
              />
      ...
      <Tabs defaultValue="overview" style={{ width: "100%" }}>
        ...
        {/* Overview Tab */}
        <TabsContent value="overview">
          <div style={{ display: "flex", flexDirection: isMobile ? "column" : "row", gap: "24px" }}> {/* Stack cards on mobile */}
            <HoverDiv
              style={{
                backgroundColor: "hsl(210, 20%, 97%)",
                border: "1px solid hsl(210, 15%, 90%)",
