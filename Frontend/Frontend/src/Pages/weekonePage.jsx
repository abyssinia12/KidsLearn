  ...
  const activitiesOverviewCard = (
    <HoverDiv
      style={{
        ...
        flex: isMobile ? "1 1 100%" : "1 1 300px", // Full width on mobile
        padding: "20px",
      }}
    >
      <CardHeader style={{ padding: "0 0 16px 0" }}>
        ...
        <CardDescription
          style={{ fontSize: "0.9rem", color: "hsl(210, 10%, 45%)" }}
        >
          ...
          return (
            ...
            >
              ...
              <div>
                ...
                <p
                  style={{ fontSize: "0.875rem", color: "hsl(210, 10%, 40%)" }}
                >
                  {desc}
                </p>
              </div>
      ...
      >
        <HoverButton
          ...
          style={{
            ...
            marginBottom: isMobile ? "16px" : "0", // Add margin below button on mobile
          }}
        >
          <ArrowLeft
        ...
        <div style={{ flex: isMobile ? "none" : "1" }}>
          ...
          <h1
            style={{
              fontSize: isMobile ? "1.75rem" : "2rem", // Smaller title on mobile
              fontWeight: "800",
              color: "hsl(210, 10%, 18%)",
              marginBottom: "4px",
            }}
          ...
          <p style={{ color: "hsl(210, 10%, 40%)", fontSize: "1rem" }}>
            Start your journey into creating amazing websites!
          </p>
        </div>
      ...
      <Tabs defaultValue="overview" style={{ width: "100%" }}>
        ...
        >
          {[
            ...
            <TabsTrigger
              ...
              value={val}
              style={{
                flex: isMobile ? "1 1 48%" : "1 1 auto", // Two columns on mobile, auto otherwise
                minWidth: isMobile ? "unset" : "120px", // Remove min-width on mobile
                padding: "10px 15px",
                borderRadius: "6px",
                fontWeight: "500",
                fontSize: "0.95rem",
                ...
                display: "flex",
                alignItems: "center",
                justifyContent: "center", // Center text in tabs
                whiteSpace: "nowrap", // Prevent text wrapping within tab
              }}
            >
              <Icon
                style={{ height: "16px", width: "16px", marginRight: "8px" }}
        ...
        <TabsContent value="video">
          ...
          >
            <h2
              style={{
                fontSize: isMobile ? "1.5rem" : "1.75rem", // Smaller title on mobile
                marginBottom: "15px",
                color: "hsl(210, 10%, 18%)",
                fontWeight: "700",
              }}
            ...
            >
              Watch the introductory video for Week 1. This video covers the
              basics of web development and SPCK editor installation.
            </p>
            <div
              style={{
                marginTop: "20px",
            ...
            >
              <a
                href="https://youtu.be/d9zz0yU2xWE"
                target="_blank"
                rel="noopener noreferrer"
                onClick={(e) => {
                  console.log("Video link clicked!");
                  // Fallback in case the href doesn't work
                  window.open("https://youtu.be/d9zz0yU2xWE", "_blank");
                }}
                style={{
                  display: "block",
                  width: "100%",
                  height: "450px",
                  backgroundColor: "hsl(210, 15%, 90%)",
                  borderRadius: "8px",
                  textDecoration: "none",
                  color: "inherit",
                  position: "relative",
            ...
            >
              ...
              >
                This comprehensive video lesson introduces you to the
                fundamentals of web development. You'll learn about the SPCK
                editor installation process, basic computer and programming
                concepts, understanding what websites are, and essential HTML
                tags to get you started on your web development journey.
              </p>
            </div>
          </HoverDiv>
        </TabsContent>
        ...
        <TabsContent value="notes">
          ...
          >
            <h2
              style={{
                fontSize: isMobile ? "1.25rem" : "1.5rem", // Smaller title on mobile
                marginBottom: "20px",
                color: "hsl(210, 80%, 50%)",
                fontWeight: "700",
              }}
